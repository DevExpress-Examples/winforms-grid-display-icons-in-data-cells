...
For more information, please see the following KB article: <a href="https://docs.devexpress.com/WindowsForms/643/controls-and-libraries/data-grid/views/grid-view/cells#how-to-put-an-image-in-a-grid-cell">How to put an image in a grid cell</a></p>
